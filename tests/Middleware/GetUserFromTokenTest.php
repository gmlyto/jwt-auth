...
use Mockery;
use D19sp\JWTAuth\Middleware\GetUserFromToken;
...
class GetUserFromTokenTest extends \PHPUnit_Framework_TestCase
{
    public function setUp()
    {
        ...
        $this->auth = Mockery::mock('D19sp\JWTAuth\JWTAuth');
    ...
    public function it_should_fire_an_event_when_no_token_is_available()
    {
        ...
        $this->events->shouldReceive('fire')->once()->with('dinho19sp.jwt.absent', [], true);
    ...
    public function it_should_fire_an_event_when_the_token_has_expired()
    {
        ...
        $this->events->shouldReceive('fire')->once()->with('dinho19sp.jwt.expired', [$exception], true);
    ...
    public function it_should_fire_an_event_when_the_token_is_invalid()
    {
        ...
        $this->events->shouldReceive('fire')->once()->with('dinho19sp.jwt.invalid', [$exception], true);
    ...
    public function it_should_fire_an_event_when_no_user_is_found()
    {
        ...
        $this->events->shouldReceive('fire')->once()->with('dinho19sp.jwt.user_not_found', [], true);
    ...
    public function it_should_fire_an_event_when_the_token_has_been_decoded_and_user_is_found()
    {
        ...
        $this->events->shouldReceive('fire')->once()->with('dinho19sp.jwt.valid', $user);
