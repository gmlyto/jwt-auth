...
class JWTAuthTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->user = Mockery::mock('D19sp\JWTAuth\Providers\User\UserInterface');
        $this->manager = Mockery::mock('D19sp\JWTAuth\JWTManager');
        $this->auth = Mockery::mock('D19sp\JWTAuth\Providers\Auth\AuthInterface');
    ...
    {
        $payload = Mockery::mock('D19sp\JWTAuth\Payload');
    ...
    {
        $this->manager->shouldReceive('getPayloadFactory->make')->once()->andReturn(Mockery::mock('D19sp\JWTAuth\Payload'));
    ...
    {
        $newToken = Mockery::mock('D19sp\JWTAuth\Token');
    ...
    public function it_should_retrieve_the_token_from_the_auth_header()
    {
        ...
        $this->assertInstanceOf('D19sp\JWTAuth\Token', $jwtAuth->parseToken()->getToken());
    ...
    public function it_should_get_the_manager_instance()
    {
        ...
        $this->assertInstanceOf('D19sp\JWTAuth\JWTManager', $manager);
    }
}
