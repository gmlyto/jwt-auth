...
use D19sp\JWTAuth\Providers\Auth\AuthInterface;
use D19sp\JWTAuth\Providers\User\UserInterface;

class JWTAuth
{
    /**
     * @var \D19sp\JWTAuth\JWTManager
     */
    protected $manager;

    /**
     * @var \D19sp\JWTAuth\Providers\User\UserInterface
     */
    protected $user;

    /**
     * @var \D19sp\JWTAuth\Providers\Auth\AuthInterface
     */
    protected $auth;
    ...
    /**
     * @param \D19sp\JWTAuth\JWTManager                   $manager
     * @param \D19sp\JWTAuth\Providers\User\UserInterface $user
     * @param \D19sp\JWTAuth\Providers\Auth\AuthInterface $auth
     ...
     *
     * @return \D19sp\JWTAuth\JWTManager
     */
